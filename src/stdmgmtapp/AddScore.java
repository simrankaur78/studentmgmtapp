...
public class AddScore extends javax.swing.JFrame {
  ...
  private void hiddencolumn(int colindex){
      TableColumn t=table.getColumnModel().getColumn(colindex);
      t.setMaxWidth(0);
      t.setMinWidth(0);
...
this.dispose();//        Myfunction.deleteCourse(Integer.parseInt(score.getText()));
...
//        hours.setValue(DEFAULT_CURSOR);
    ...
    private void addActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_addActionPerformed
          ...
          try{
          editdeletescore.table.setModel(new DefaultTableModel(null,new Object[]{"sid","cid","score","description"}));
          Myfunction.fillScoreTable(editdeletescore.table,"") ;    
